...
Page({
  ...
  loadEdit: function (e) {
    console.log(e);
    console.log('../../pages/treatment/treatment?caseId=' +encodeURIComponent( e.currentTarget.dataset.caseid) 
 ...
 */
  ...
  //查询一级系统病症
  getFirstProject: function (isAdd) {
    let that = this;
    wx.request({
      ...
      success: function (res) {
        ...
        that.setData({
          ...
          isCaseProject: !isAdd?data.data[0].id:''
        })
        that.getSecondDesc(!isAdd?data.data[0].id:'');
      }
    })
  },
  //查询二级病症
